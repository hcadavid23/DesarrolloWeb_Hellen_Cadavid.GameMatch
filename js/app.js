...
//para colocar los caramelos en el tablero
function checkBoard() {
	fillBoard();
}
...
//temporizador y boton reiniciar, cambia el aspecto de la página final del juego
